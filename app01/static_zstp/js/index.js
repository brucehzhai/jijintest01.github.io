var $messages = $('.messages-content'),
    ...
    i = 0;
function initTips(){
  let tips = "您好!我是小智，您可以这样问我：<br>" +
      "介绍一下西湖龙井茶"
  $('<div class="message new"><figure class="avatar"><img src="/static/res/botim.png" /></figure>' + tips + '</div>').appendTo($('.mCSB_container')).addClass('new');
  updateScrollbar();
}
